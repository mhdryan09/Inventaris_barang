...
class Laporan_pengeluaran extends CI_Controller
{
    public function __construct()
    {
        ...
        //load data di modal barang, supplier dan Pengeluaran
        $this->load->model(['Barang_Model', 'Supplier_Model', 'Pengeluaran_Model']);
    }
    ...
    public function cetak_pengeluaran()
    {
        ...
        $this->template->load('template', 'laporan/laporan_pengeluaran/form_pengeluaran', $data);
    }
    ...
    public function cetak_periode()
    {
        ...
        <page>
            ...
            <h3 style="text-align: center;">
                Laporan Data Pengeluaran Barang
            </h3>
        ...
        $data = $this->Pengeluaran_Model->cetak_tanggal(@$_POST['tgl_awal'], @$_POST['tgl_akhir'])->result();
        ...
        $html2pdf->output('barang_keluar.pdf');
    }
}
