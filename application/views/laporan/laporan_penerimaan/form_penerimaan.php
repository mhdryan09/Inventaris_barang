    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-success"> <br>
                <form method="post" action="<?= site_url('Laporan_penerimaan/cetak_periode'); ?>" class="form-horizontal">
                    <div class="box-body bg-lightskyblue">
                        <div class="form-group">
                            <label class="col-sm-1">Tanggal</label>
                            <div class="col-sm-2">
                                <input type="text" class="tanggal form-control" name="tgl_awal" autocomplete="off">
                            </div>
                ...
                <div class="box-body table-responsive">
                    <h4><i class="fa fa-file-text-o icon-title"></i>
                        Data Transaksi Penerimaan</h4> <br>
                    ...
                    <!-- <a href="<?= site_url('report/cetak_barang_masuk'); ?>" style="float: right" class="btn btn-danger">
