    ...
    <div class="box box-success">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?= site_url('pengadaan_barang/barang_pengadaan') ?>" class="btn btn-default">
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="<?= site_url('pengadaan_barang/process'); ?>" method="post">
                                <div class="form-group">
                                    <label for="">Tanggal Pengadaan Barang</label>
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" name="kode_barang" id="kode_barang" class="form-control" required autofocus placeholder="Cari Barang">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keterangan" class="form-control" placeholder="Pengadaan barang untuk .. " required autocomplete="off">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" style="float: right;">
                                    <button type="submit" name="barang_ada" class="btn btn-primary">
                        ...
                        <?php foreach ($barang as $i => $data) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button class="btn btn-sm btn-success" id="select" data-id="<?= $data->id_barang ?>" data-kode_barang="<?= $data->kode_barang ?>" data-nama="<?= $data->nama_barang ?>" data-satuan="<?= $data->satuan_barang_name ?>" data-stok="<?= $data->stok ?>">
